{
  ...
  inputs = {
    ...
    ghostty.url = "github:ghostty-org/ghostty/1c0677faabf79b5dbaf96eef058e0a16983d0538";
    ...
    emmylua-analyzer-rust.url = "github:EmmyLuaLs/emmylua-analyzer-rust/0658443479281ef78e73329d56324974cf1336eb";
