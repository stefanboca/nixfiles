{
  ...
  inputs = {
    ...
    ghostty.url = "github:ghostty-org/ghostty/206d41844e88176a398f149e8e2c8f6e2fdbd28a";
    ...
    emmylua-analyzer-rust.url = "github:EmmyLuaLs/emmylua-analyzer-rust/6cc7f6295c546071eb946529d879a71aff56133d";
